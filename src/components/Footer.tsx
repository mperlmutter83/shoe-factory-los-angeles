  ...
  return (
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-3 gap-8">
        ...
        <div><h4 className="font-bold mb-4">Follow Us</h4><div className="flex gap-4"><a href="#" className="text-gray-400 hover:text-white">FB</a><a href="#" className="text-gray-400 hover:text-white">X</a><a href="#" className="text-gray-400 hover:text-white">IG</a></div>
          <p className="mt-6"><Link href="/looking-for-work" className="text-gray-400 hover:text-amber-400 underline underline-offset-4">Looking for Work</Link></p>
        </div>
      </div>
